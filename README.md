...
**Team gaming platform** It is a web application for playing team games like “Bunker” in real time. Users can create their own game rooms and communicate by text, video, and voice chat. The app also includes tools to help with the game, such as role selection and timers.
